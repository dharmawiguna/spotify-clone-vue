...
const loadmetadata = () => {
  audio.value.addEventListener("loadedmetadata", function () {
    ...
    isTrackTimeTotal = minutes + ":" + seconds.toString().padStart(2, "0");
  });
};
    ...
    <div class="flex items-center w-1/4">
      <div class="flex items-center ml-4">
        ...
        <div class="ml-4">
          ...
          <div
            class="text-[11px] uppercase text-gray-400 hover:underline hover:text-white cursor-pointer"
          >
    ...
    <div class="max-w-[35%] mx-auto w-2/4 mb-3">
      ...
      <div class="flex items-center h-[25px]">
        ...
        <div
          ...
          class="text-white text-[12px] pr-2 pt-[11px] ml-2"
        >
          {{ isTrackTimeTotal }}
        </div>
      </div>
